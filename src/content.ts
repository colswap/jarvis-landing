...
export const LIVE = {
  ...
  honestAmber: "빈 화면이다",
  honestAfter:
    ". 늘 켜 두는 서버가 아니라 작업 중에만 살아 있는 자리라서 그렇다. 비어 있다면 지금은 아무도 만들고 있지 않다는 뜻이고, 그것도 이 계기가 읽어 주는 값 중 하나다.",
  cta: "빈 화면일 수 있는 주소 열기",
  lamps: [
    { tone: "on", label: "WORKING", text: "빌드가 도는 중이면 화면이 자라는 것을 본다" },
    { tone: "wait", label: "WAITING", text: "사람의 선택을 기다리는 중이면 멈춰 있다" },
    { tone: "off", label: "IDLE", text: "아무도 만들고 있지 않으면 빈 화면이다" },
  ],
} as const
